...
// File: contracts/strategies/BTCStrategyArbV1.sol
...
contract BTCStrategyArbV1 is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public minAmountProfit = 1e13; // Total profit must be greater than 0.005% for executor to earn from trade
