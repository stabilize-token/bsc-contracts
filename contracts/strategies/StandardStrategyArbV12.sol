...
contract StandardStrategyArbV12 is Ownable {
    ...
    address constant SYNAPSE_EXCHANGE = address(0x28ec0B36F0819ecB5005cAB836F4ED5a2eCa4D1);
    ...
    function exchange(uint256 _idIn, uint256 _idOut, uint256 _amount, uint256 _exchangeNum) internal {
        ...
        if(_idOut == WBNB_TOKEN_ID){
            ...
            if(_exchangeNum == 0){
                ...
                exchange.swap(tokenList[_idIn].synapseID, tokenList[_idOut].synapseID, _amount, 1, now.add(60));
                return;
            }
        }
    }
